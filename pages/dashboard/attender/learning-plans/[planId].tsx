        ...
        <UnifiedDashboardLayout role="attender">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid gap-4">
                                            {currentWeek.questions.map((question: any, idx: number) => {
                                                ...
                                                return (
                                                    <Card key={idx} className="border-border hover:shadow-md transition-all group">
                                                        <CardContent className="p-5 flex flex-col md:flex-row md:items-center gap-5">
                                                            ...
                                                            <div className="shrink-0">
                                                                <Button
                                                                    ...
                                                                    className={isSolved ? "" : "bg-primary hover:bg-primary/90"}
                                                                    onClick={() => {
            ...
            {showPlayground && selectedQuestion && (
                <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <Card className="w-full max-w-7xl max-h-[90vh] overflow-hidden flex flex-col border-border shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                        <CardHeader className="border-b border-border bg-card py-3 px-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <Code className="w-5 h-5 text-primary" />
                                    <div>
                                        <CardTitle className="text-base font-semibold">{selectedQuestion.questionText}</CardTitle>
                                        <CardDescription className="text-xs">
                                            {selectedQuestion.language} • {selectedQuestion.difficulty}
                                        </CardDescription>
                                    </div>
                                </div>
                                <Button
