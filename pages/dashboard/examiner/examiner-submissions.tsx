        ...
        try {
            ...
            sortedAnswers.forEach((answerItem, index) => {
                ...
                if (answerItem.type === 'mcq' && answerItem.selectedOption !== undefined) {
                    addText(`Selected Option: ${String.fromCharCode(65 + answerItem.selectedOption)} - ${studentAnswer}`, 9, false); // Reduced from 10
                } else {
            ...
            // ===== FOOTER ON LAST PAGE WITH SYSRANK =====
            y = pageHeight - 20;
            doc.setFontSize(8);
            doc.setFont('helvetica', 'normal');
            doc.setTextColor(107, 114, 128);
            ...
            // doc.text('www.sysrank.com', margin, y);
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="px-4 py-2 bg-white dark:bg-gray-800 rounded-full border border-border shadow-sm">
                                    <span className="text-sm font-medium text-muted-foreground">Total: </span>
                                    <span className="text-lg font-bold text-foreground">{submissions.length}</span>
                                </div>
                            </div>
                        </div>

                        {/* Tabs */}
                        <div className="flex items-center gap-2 bg-white dark:bg-gray-800 p-1 rounded-lg border border-border shadow-sm w-fit">
                            <button
                                onClick={() => setActiveTab('all')}
                                className={`px-6 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'all'
                            ...
                            <button
                                ...
                                className={`px-6 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'qualified'
                            ...
                            <button
                                ...
                                className={`px-6 py-2 rounded-md text-sm font-medium transition-all ${activeTab === 'disqualified'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                        ...
                        <Card className="border-0 shadow-md bg-gradient-to-br from-green-500 to-green-600 text-white">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-green-100 text-sm font-medium mb-1">Qualified</p>
                        ...
                        <Card className="border-0 shadow-md bg-gradient-to-br from-red-500 to-red-600 text-white">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-red-100 text-sm font-medium mb-1">Disqualified</p>
                                        <p className="text-3xl font-bold">{disqualifiedCount}</p>
                                    </div>
                                    <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-6">
                            {Object.entries(groupedSubmissions).map(([examId, examSubmissions]) => {
                                ...
                                return (
                                    <Card key={examId} className="border-0 shadow-lg overflow-hidden">
                                        <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 border-b">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <CardTitle className="text-xl font-bold">{examId}</CardTitle>
