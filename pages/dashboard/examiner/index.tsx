...
export default function ExaminerDashboard() {
    ...
    const quickActions = [
        {
            ...
            icon: Plus,
            action: () => router.push('/dashboard/examiner/create'),
            color: "text-blue-600",
        ...
        },
        {
            ...
            icon: Database,
            action: () => router.push('/dashboard/examiner/questions'), // Assuming this route exists or will exist
        ...
        },
        {
            ...
            icon: BarChart3,
            action: () => router.push('/dashboard/examiner/ExamAnalytics'),
    ...
    return (
        <UnifiedDashboardLayout role="examiner">
            <Head>
                <title>Examiner Dashboard - SysRank</title>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight text-foreground">
                                Welcome back, {session?.user?.name?.split(' ')[0] || 'Examiner'}! 👋
                            </h1>
                            <p className="text-muted-foreground mt-1">
                                Here's what's happening with your assessments today.
                            </p>
                        </div>
                        <Button onClick={() => router.push('/dashboard/examiner/create')} className="bg-primary hover:bg-primary/90 transition-colors">
                            ...
                            <Card className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 border-purple-100 dark:border-purple-900">
                                ...
                                <CardContent>
                                    <Button
                                        ...
                                        onClick={() => router.push('/dashboard/examiner/create')}
                                    >
                                        Try it now
                                    </Button>
                                </CardContent>
