    ...
    try {
        ...
        const params: any = {
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an educational AI generating detailed exam reports. Be specific and data-driven. Return only valid JSON."
                },
        ...
        console.error("Exam report generation error:", error);
